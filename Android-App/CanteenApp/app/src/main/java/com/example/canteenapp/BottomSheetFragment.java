...
public class BottomSheetFragment extends BottomSheetDialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       prepText.setText("Thank you for your order! Your wait time is approximately " + preparationTime + " minutes");
       QRGEncoder qrgEncoder = new QRGEncoder(String.valueOf(total), null, QRGContents.Type.TEXT, 200);
        try {
